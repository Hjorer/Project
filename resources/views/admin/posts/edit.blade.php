                    ...
                    <form role="form" method="post" action="{{ route('posts.update', ['post' => $post->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('blog__category_id') is-invalid @enderror" id="blog__category_id" name="blog__category_id">
                                    @foreach($categories as $k => $v)
                                    <option value="{{ $k }}" @if($k==$post->blog__category_id) selected @endif>{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
